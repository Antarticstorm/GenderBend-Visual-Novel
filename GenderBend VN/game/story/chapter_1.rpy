...
label chapter_1:
    ...
    show tansy happy at tansy_size, char_center, enter_from_right
    ...
    # Closest available interior background: Laughing Anchor.
    ...
    menu:
        ...
        "I'll handle the market merchant fair and square. The Guild's reputation will stay clean.":
            ...
            show clara normal at char_center, expression_pop
